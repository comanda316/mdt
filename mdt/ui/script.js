const mdtApp = new Vue({
    ...
    methods: {
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.identifier && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://mdt/submitNewReport', JSON.stringify({
                    title: this.report_new.title,
                    identifier: this.report_new.identifier,
                ...
                this.report_new.identifier = null;
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://mdt/submitNewWarrant', JSON.stringify({
                ...
                identifier: this.warrant_new.identifier,
